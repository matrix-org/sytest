...
sub _get_dbconfigs
{
   ...
   foreach my $db ( keys %db_configs ) {
      ...
      # $db_config->{name} is a reference to the `name` field in the configuration
      # generated by either of the two "prep" scripts used by Synapse. It is a direct
      # reference to the DBAPI2 python module used by Synapse's database. Parse which
      # "type" of database that means for the subroutine that cleans up the database
      # before a test run. See the `_clear_db_`"type" subroutine variants further down
